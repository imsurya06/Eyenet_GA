    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 md:px-8 lg:px-[80px]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button asChild variant="outline" className="px-6 py-3 text-text-regular border-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground">
