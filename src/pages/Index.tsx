  ...
  return (
    <>
      {/* 
        ...
        - Adaptive Viewport Scale ONLY on short viewports/TV displays (height < 840px) so no content is cropped
      */}
      <div className="relative flex flex-col lg:flex-row items-center justify-between px-6 sm:px-8 lg:px-[80px] bg-background min-h-[85vh] py-8 lg:py-12 [@media(max-height:840px)]:py-4 lg:gap-x-12 overflow-hidden">
        ...
        <AnimateOnScroll isHero={true} delay={100} className="relative z-10 text-center lg:text-left max-w-xl lg:max-w-2xl lg:w-1/2 flex flex-col justify-center items-center lg:items-start my-auto h-full w-full">
          <div className="w-full flex flex-col justify-center items-center lg:items-start animate-float-smooth will-change-transform">
            <h1 className="text-[42px] xs:text-[48px] sm:text-6xl lg:text-[58px] xl:text-[76px] [@media(max-height:840px)]:text-[44px] [@media(max-height:840px)]:xl:text-[54px] font-heading font-normal mb-4 xl:mb-6 [@media(max-height:840px)]:mb-3 text-foreground leading-[1.08] xl:leading-[1.05] tracking-normal drop-shadow-sm lg:drop-shadow-none text-center lg:text-left">
            ...
            {/* Hero Description */}
            <p className="text-base sm:text-lg xl:text-text-large font-body mb-6 xl:mb-8 [@media(max-height:840px)]:mb-4 text-gray-600 drop-shadow-sm lg:drop-shadow-none leading-relaxed max-w-md lg:max-w-lg text-center lg:text-justify mx-auto lg:mx-0">
        ...
        {/* Right Section: Pixel-Perfect Bento Grid (Scales down ONLY on short screens/TVs) */}
        <AnimateOnScroll isHero={true} delay={200} className="relative z-10 w-full lg:w-1/2 flex justify-center lg:justify-end items-center py-6 [@media(max-height:840px)]:py-2">
          <div className="w-full max-w-[540px] [@media(max-height:840px)]:max-w-[450px] flex flex-col gap-3.5 sm:gap-4 [@media(max-height:840px)]:gap-2.5">
            
            {/* Top Grid Block: Fashion Model (7 cols) + Stacked Computer & Active Makeup (5 cols) */}
            <div className="grid grid-cols-12 gap-3.5 sm:gap-4 [@media(max-height:840px)]:gap-2.5 items-stretch">
              
              {/* 1. Main Feature Image: Fashion Designing */}
              <div className="col-span-7 relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xs bg-slate-100 group min-h-[220px] [@media(max-height:840px)]:min-h-[160px]">
                <img
              ...
              <div className="col-span-5 flex flex-col gap-3.5 sm:gap-4 [@media(max-height:840px)]:gap-2.5">
            ...
            <div className="grid grid-cols-12 gap-3.5 sm:gap-4 [@media(max-height:840px)]:gap-2.5 h-[135px] sm:h-[160px] md:h-[175px] [@media(max-height:840px)]:h-[120px]">
