...
const StudentWriteBlogSection = () => {
  ...
  // The client-side addBlog and toast.success will not execute before page reload.
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <AnimateOnScroll delay={300}>
          <div className="bg-white p-8 md:p-10 rounded-lg shadow-md border border-gray-200">
            {/* Formspree integration: action and method attributes */}
            <form action="https://formspree.io/f/myzbeqer" method="POST" className="grid gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Your amazing blog title" {...field} name="title" required /> {/* Added name and required */}
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Jane Doe" {...field} name="author" required /> {/* Added name and required */}
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    {field.value && ( // Hidden input to send date value
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Write your blog post here..." rows={10} {...field} name="content" required /> {/* Added name and required */}
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormControl>
                  <Label htmlFor="blog-image-upload" className="flex flex-col items-center justify-center w-full h-48 border border-input bg-muted rounded-md cursor-pointer hover:bg-accent transition-colors">
                    ...
                    <Input
                      ...
                      name="imageFile" // Added name attribute
                    />
                  </Label>
                </FormControl>
