...
const Index = () => {
  return (
    <>
      ...
      */}
      <div className="relative flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 lg:px-[80px] bg-background min-h-[80vh] lg:min-h-[calc(100vh-130px)] py-6 sm:py-8 lg:py-6 lg:gap-x-12 overflow-hidden">
