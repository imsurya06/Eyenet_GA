...
const Index = () => {
  return (
    <>
      {/* 
        Hero Section:
        - Viewport Height Constrained (lg:h-[calc(100vh-130px)])
        - 100% visible on initial load (0 scroll position) across all display sizes (TVs, Monitors, Laptops)
      */}
      <div className="relative flex flex-col lg:flex-row items-center justify-between px-6 sm:px-8 lg:px-[80px] bg-background min-h-[calc(100vh-130px)] lg:h-[calc(100vh-130px)] py-4 lg:py-6 lg:gap-x-12 overflow-hidden">
        ...
        <AnimateOnScroll isHero={true} delay={100} className="relative z-10 text-center lg:text-left max-w-xl lg:max-w-2xl lg:w-1/2 flex flex-col justify-center items-center lg:items-start my-auto h-full w-full">
          <div className="w-full flex flex-col justify-center items-center lg:items-start animate-float-smooth will-change-transform">
            <h1 className="text-[36px] xs:text-[44px] sm:text-5xl lg:text-[52px] xl:text-[68px] 2xl:text-[76px] font-heading font-normal mb-3 xl:mb-5 text-foreground leading-[1.08] xl:leading-[1.05] tracking-normal drop-shadow-sm lg:drop-shadow-none text-center lg:text-left">
            ...
            {/* Hero Description */}
            <p className="text-sm sm:text-base xl:text-text-large font-body mb-5 xl:mb-7 text-gray-600 drop-shadow-sm lg:drop-shadow-none leading-relaxed max-w-md lg:max-w-lg text-center lg:text-justify mx-auto lg:mx-0">
        ...
        {/* Right Section: Pixel-Perfect Bento Grid (Viewport Height Adaptive) */}
        <AnimateOnScroll isHero={true} delay={200} className="relative z-10 w-full lg:w-1/2 flex justify-center lg:justify-end items-center py-2 lg:py-4 h-full">
          <div className="w-full max-w-[480px] xl:max-w-[540px] h-[calc(100vh-220px)] max-h-[500px] flex flex-col justify-between gap-3 sm:gap-4">
            ...
            <div className="grid grid-cols-12 gap-3 sm:gap-4 flex-1 items-stretch">
              ...
              <div className="col-span-7 relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xs bg-slate-100 group min-h-[160px]">
                <img
            ...
            <div className="grid grid-cols-12 gap-3 sm:gap-4 h-[32%] min-h-[100px] max-h-[175px]">
