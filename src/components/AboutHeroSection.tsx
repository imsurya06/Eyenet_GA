...
const AboutHeroSection = () => {
  return (
    <section className="py-6 sm:py-8 md:py-12 px-4 md:px-8 lg:px-[80px] bg-background text-foreground min-h-[calc(100dvh-125px)] max-h-[none] lg:max-h-[calc(100dvh-80px)] flex flex-col justify-center overflow-hidden">
      <div className="max-w-7xl mx-auto w-full my-auto">
        ...
        {/* Hero Showcase 3D Perspective Carousel (Viewport Height Fitted) */}
        <div className="mb-8 md:mb-12 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden max-h-[calc(100dvh-260px)] flex items-center justify-center">
