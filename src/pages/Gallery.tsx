          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col gap-6">
              <AnimateOnScroll isHero={true} delay={300}> {/* Reduced delay */}
                <div className="w-full h-[400px] md:h-[550px] overflow-hidden rounded-lg shadow-md">
                  <img src="/images/img1.png" alt="Traditional attire model 1" className="w-full h-full object-contain" />
                </div>
              </AnimateOnScroll>
              <AnimateOnScroll isHero={true} delay={400}> {/* Reduced delay */}
                <div className="w-full h-[250px] overflow-hidden rounded-lg shadow-md">
                  <img src="/images/img4.png" alt="Fashion show model 2" className="w-full h-full object-contain" />
                </div>
              </AnimateOnScroll>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <AnimateOnScroll isHero={true} delay={500}> {/* Reduced delay */}
                <div className="w-full h-[250px] overflow-hidden rounded-lg shadow-md">
                  <img src="/images/img2.png" alt="Fashion show model 1" className="w-full h-full object-contain" />
                </div>
              </AnimateOnScroll>
              <AnimateOnScroll isHero={true} delay={600}> {/* Reduced delay */}
                <div className="w-full h-[250px] overflow-hidden rounded-lg shadow-md">
                  <img src="/images/img3.png" alt="Traditional attire model 2" className="w-full h-full object-contain" />
                </div>
              </AnimateOnScroll>
            </div>
          </div>
