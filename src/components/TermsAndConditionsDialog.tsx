...
const TermsAndConditionsDialog: React.FC<TermsAndConditionsDialogProps> = ({ open, onOpenChange }) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] p-6 md:p-8 max-h-[90vh] flex flex-col">
        <DialogHeader>
        ...
        <ScrollArea className="flex-1 pr-4">
          <div className="text-text-regular font-body text-gray-700 space-y-4">
            ...
            <ul>
              <li>By email: info@eyenet.com (placeholder email)</li>
              <li>By visiting this page on our website: https://www.eyenet.com/contact (placeholder URL)</li>
            </ul>
          </div>
        </ScrollArea>
        <DialogFooter className="mt-4">
          <Button onClick={() => onOpenChange(false)} className="bg-primary hover:bg-primary/90 !text-white px-6 py-3 text-text-regular">
            Close
          </Button>
        </DialogFooter>
      </DialogContent>
