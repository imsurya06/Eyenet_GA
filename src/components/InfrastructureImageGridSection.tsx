      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
            <AnimateOnScroll delay={300}>
              <div className="w-full h-[250px] overflow-hidden rounded-lg shadow-md">
                <img src="/images/pexels-pixabay-256491.jpg" alt="Computer Lab" className="w-full h-full object-contain" />
              </div>
            </AnimateOnScroll>
            <AnimateOnScroll delay={400}>
              <div className="w-full h-[250px] overflow-hidden rounded-lg shadow-md">
                <img src="/images/pexels-tima-miroshnichenko-6550407.jpg" alt="Classroom" className="w-full h-full object-contain" />
              </div>
            </AnimateOnScroll>
          </div>
          ...
          <AnimateOnScroll delay={500} className="w-full h-[524px] overflow-hidden rounded-lg shadow-md"> {/* Adjusted height to match stacked images + gap */}
            <img src="/images/pexels-pixabay-356065.jpg" alt="Library" className="w-full h-full object-contain" />
          </AnimateOnScroll>
        </div>
      </div>
    </section>
